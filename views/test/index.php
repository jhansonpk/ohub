...
<section>
    <header class="container">
        ...
        <form>
            <div class="row">
                <div class="form-group col-sm-4 col-xs-12"> <input type="email" class="form-control" id="email" placeholder="Digite seu e-mail" required> </div>
                <div class="form-group col-sm-6 col-xs-12"> <input type="text" class="form-control" id="address" placeholder="Digite seu endereço comercial" required> </div>
